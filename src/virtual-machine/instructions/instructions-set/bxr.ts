...
export class BinaryExclusiveOrInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x7000;
    public static OPCODE: string = 'bxr';
    ...
    public decode(): string {
        return `${BinaryExclusiveOrInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }
