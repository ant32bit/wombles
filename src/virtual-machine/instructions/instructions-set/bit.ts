...
export class BranchIfTrueInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x9800;
    public static OPCODE: string = 'bit';
    ...
    public decode(): string {
        return `${BranchIfTrueInstruction.OPCODE} $${this._testRegister}, $${this._offsetRegister}`;
    }

    public encode(): number {
        const args = [this._testRegister, this._offsetRegister, 0]
        return pack(BranchIfTrueInstruction.HEAD, BranchIfTrueInstruction.PACK, args);
    }
