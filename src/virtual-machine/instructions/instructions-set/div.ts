...
export class DivisionInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x5000;
    public static OPCODE: string = 'div';
    ...
    public decode(): string {
        return `${DivisionInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(DivisionInstruction.HEAD, DivisionInstruction.PACK, args);
    }
