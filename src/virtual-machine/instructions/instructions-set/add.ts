...
export class AdditionInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x4400;
    public static OPCODE: string = 'add';
    ...
    public decode(): string {
        return `${AdditionInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(AdditionInstruction.HEAD, AdditionInstruction.PACK, args);
    }
