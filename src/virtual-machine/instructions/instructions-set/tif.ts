...
export class TestIfFalseInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0xBC00;
    public static OPCODE: string = 'tif';
    ...
    public decode(): string {
        return `${TestIfFalseInstruction.OPCODE} $${this._testRegister}, $${this._destinationRegister}`;
    }
