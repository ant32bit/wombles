...
export class RightShiftInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x7C00;
    public static OPCODE: string = 'rsh';
    ...
    public decode(): string {
        return `${RightShiftInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }
