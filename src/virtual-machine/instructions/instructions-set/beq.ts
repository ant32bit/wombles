...
export class BranchEqualInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x8000;
    public static OPCODE: string = 'beq';
    ...
    public decode(): string {
        return `${BranchEqualInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._offsetRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._offsetRegister]
        return pack(BranchEqualInstruction.HEAD, BranchEqualInstruction.PACK, args);
    }
}
