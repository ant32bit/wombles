...
export class TestEqualInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0xA000;
    public static OPCODE: string = 'teq';
    ...
    public decode(): string {
        return `${TestEqualInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(TestEqualInstruction.HEAD, TestEqualInstruction.PACK, args);
    }
}
