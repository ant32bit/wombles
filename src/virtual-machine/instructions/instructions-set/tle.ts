...
export class TestLessOrEqualInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0xAC00;
    public static OPCODE: string = 'tle';
    ...
    public decode(): string {
        return `${TestLessOrEqualInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(TestLessOrEqualInstruction.HEAD, TestLessOrEqualInstruction.PACK, args);
    }
}
