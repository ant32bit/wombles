...
export class BranchGreaterThanInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x9000;
    public static OPCODE: string = 'bgt';
    ...
    public decode(): string {
        return `${BranchGreaterThanInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._offsetRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._offsetRegister]
        return pack(BranchGreaterThanInstruction.HEAD, BranchGreaterThanInstruction.PACK, args);
    }
}
