...
export class TestNotEqualInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0xA400;
    public static OPCODE: string = 'tne';
    ...
    public decode(): string {
        return `${TestNotEqualInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(TestNotEqualInstruction.HEAD, TestNotEqualInstruction.PACK, args);
    }
