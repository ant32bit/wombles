...
export class TestGreaterOrEqualInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0xA800;
    public static OPCODE: string = 'tge';
    ...
    public decode(): string {
        return `${TestGreaterOrEqualInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(TestGreaterOrEqualInstruction.HEAD, TestGreaterOrEqualInstruction.PACK, args);
    }
}
