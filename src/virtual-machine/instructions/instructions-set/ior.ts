...
export class LogicalOrInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x5C00;
    public static OPCODE: string = 'ior';
    ...
    public decode(): string {
        return `${LogicalOrInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }
