...
export class BranchLessOrEqualInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x8C00;
    public static OPCODE: string = 'ble';
    ...
    public decode(): string {
        return `${BranchLessOrEqualInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._offsetRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._offsetRegister]
        return pack(BranchLessOrEqualInstruction.HEAD, BranchLessOrEqualInstruction.PACK, args);
    }
