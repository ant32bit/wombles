...
export class BranchGreaterOrEqualInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x8800;
    public static OPCODE: string = 'bge';
    ...
    public decode(): string {
        return `${BranchGreaterOrEqualInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._offsetRegister}`;
    }
