...
export class LogicalExclusiveOrInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x6000;
    public static OPCODE: string = 'xor';
    ...
    public decode(): string {
        return `${LogicalExclusiveOrInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(LogicalExclusiveOrInstruction.HEAD, LogicalExclusiveOrInstruction.PACK, args);
    }
