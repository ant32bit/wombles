...
export class MultiplicationInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x4C00;
    public static OPCODE: string = 'mul';
    ...
    public decode(): string {
        return `${MultiplicationInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }
