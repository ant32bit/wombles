...
export class TestLessThanInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0xB400;
    public static OPCODE: string = 'tlt';
    ...
    public decode(): string {
        return `${TestLessThanInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }

    public encode(): number {
        const args = [this._rhsRegister, this._lhsRegister, this._destinationRegister]
        return pack(TestLessThanInstruction.HEAD, TestLessThanInstruction.PACK, args);
    }
}
