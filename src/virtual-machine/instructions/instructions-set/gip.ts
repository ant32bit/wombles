...
export class GetInstructionPointerInstruction implements IInstruction {

    public static MASK: number = 0xFFF0;
    public static PACK: number[] = [12,4];
    public static HEAD: number = 0x02C0;
    public static OPCODE: string = 'gip';
    ...
    public decode(): string {
        return `${GetInstructionPointerInstruction.OPCODE} $${this._destinationRegister}`;
    }
