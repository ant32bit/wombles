...
export class ModulusInstruction implements IInstruction {

    public static MASK: number = 0xFC00;
    public static PACK: number[] = [6,4,4,2];
    public static HEAD: number = 0x5400;
    public static OPCODE: string = 'mod';
    ...
    public decode(): string {
        return `${ModulusInstruction.OPCODE} $${this._rhsRegister}, $${this._lhsRegister}, $${this._destinationRegister}`;
    }
